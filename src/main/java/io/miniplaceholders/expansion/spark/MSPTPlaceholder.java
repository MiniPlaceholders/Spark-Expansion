...
public final class MSPTPlaceholder implements GlobalTagResolver {
    @Override
    public Tag tag(ArgumentQueue argumentQueue, Context context) {
        final GenericStatistic<DoubleAverageInfo, StatisticWindow.MillisPerTick> stats;
        try {
            stats = SparkProvider.get().mspt();
